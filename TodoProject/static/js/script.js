...
const printTodoItem = (text) => {
  ...
  todoBtn_img.setAttribute("src", imageUrl);
  todoDel_img.setAttribute("src", "/todoproject/static/img/close.png");
...
const printDoneItem = (text) => {
  ...
  doneBtn_img.setAttribute("src", "/todoproject/static/img/full-check.png");
  doneUp_img.setAttribute("src", "/todoproject/static/img/img/up.png");
  doneDel_img.setAttribute("src", "/todoproject/static/img/close.png");
